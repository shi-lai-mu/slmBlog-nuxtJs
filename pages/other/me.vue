        ...
        <article class="content-box thisSite">
            ...
            <ul class="web-details">
                <li>
                    ...
                    <p>
                      初三[下]：退出后我开始尝试找合伙人创立一个自己的服务器,这时开始接触了<b>Linux的操作[2015]</b>。这是一段快乐是时光,我们的服务器每天都有两位数的玩家,然后便有了玩家赞助VIP。
                    </p>
                </li>
                <li>
                    <span>高中:</span>
                    <p>
                      ...
                      随后我靠着申请开发者的插件,开启了<b>[代码赚钱 第一桶金]</b>这笔收入对当时的我不小,一天平均两三百左右。后面,和初中同学的约定下开发了自己的APP可以下单的软件[web 嵌入式],就是个网站在宿舍宣传,
                      赚了点钱后被宿舍管理员发现,找我去谈话想合作一起搞,被我拒绝...其实是因为挺忙的。
                    </p>
                    <p>
                      高一[下]： 我开始了更新插件版本,建立售后群/售后服务的生活,当时我所<b>担任的职位有[客服/开发者/服主/接单定制插件]</b>，每天都在赚钱都在忙。后来有了新想法，开发了第二个,第三个,服务器插件并且全上了"精品"二字的归类,
                      平台规定三个精品插件可升为"高级开发者",于是我便有了更多权限。随后接触了<b>[Android 开发]</b>
                    </p>
                    <p>
                    ...
                    <p>
                      高三[上]： [2018-7]赚取了六位数后,我的世界被网易发现了,并采取了代理措施。平台被网易整跨,宣布18-7停止出售授权,19-7闭站和关闭授权系统。我退出了平台。
                ...
                <li>
                    <span>大学:</span>
                    <p>
                      大一[上]： 入学后被学长发现,拉入工作室,随后加入任课老师的公司兼职<b>[2018-10 开始自学小程序]</b>写公司产品(边学边写公司的东西也没谁了),后面又加入社团担任[宣传部长]开发小程序,在社团开展活动时让观众用,
                      提高了社团可以说是逼格吧2333...从那至今[2019-3][7个月 陆续学习和稳固前端的知识]
                    </p>
                </li>
            </ul>
